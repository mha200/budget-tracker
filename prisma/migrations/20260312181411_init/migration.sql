...
CREATE TABLE "MasterBudget" (
    ...
    CONSTRAINT "MasterBudget_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "MasterBudget_categoryId_year_key" ON "MasterBudget"("categoryId", "year");
...
-- AddForeignKey
ALTER TABLE "MasterBudget" ADD CONSTRAINT "MasterBudget_categoryId_fkey" FOREIGN KEY ("categoryId") REFERENCES "Category"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "Expense" ADD CONSTRAINT "Expense_statementId_fkey" FOREIGN KEY ("statementId") REFERENCES "UploadedStatement"("id") ON DELETE SET NULL ON UPDATE CASCADE;
